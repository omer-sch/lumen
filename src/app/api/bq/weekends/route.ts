...
import { queryGlobalComixWeekends } from "@/lib/globalcomix-queries";
...
/**
 * GET /api/bq/weekends — Weekends vs Weekdays bucket totals.
 * Non-multi-source clients return an empty array.
 */
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const data = await queryGlobalComixWeekends(
      params.client,
      params.from,
      params.to,
      filter,
    ...
    return bqErrorResponse(err, "weekends");
  }
}
